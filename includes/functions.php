 ...
 */
function cf7cw_defaults() {
	$cf7cw_defaults = array(
		'whatsapp_info' => array(
			'country_name' => '',
			'country_code' => '',
			'wh_number' => ''
	...
	return $cf7cw_defaults;
}

function cf7cw_options(){
	$cf7cw_defaults = cf7cw_defaults();
	$cf7cw_options = get_option('cf7cw_options', $cf7cw_defaults );
	
	return apply_filters('cf7cw_options', $cf7cw_options);
}